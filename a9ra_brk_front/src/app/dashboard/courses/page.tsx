...
import { Search, Bell, Mail, Globe, BookOpen, Layers, User, Award, Settings, Plus, ChevronRight } from "lucide-react"
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="mb-8">
            <Link
              ...
              className="inline-flex items-center gap-2 text-[#5570f1] font-medium"
            >
              <div className="flex items-center justify-center w-8 h-8 rounded-full border border-[#5570f1]">
