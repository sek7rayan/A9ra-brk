      ...
      <aside className="w-64 bg-white border-r hidden md:flex flex-col">
        ...
        <nav className="flex-1 py-6">
          <ul className="space-y-2">
            <li>
              <Link href="/dashboard" className="flex items-center gap-3 px-6 py-3 text-white bg-[#5570f1] font-medium">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="flex flex-wrap gap-3">
              <button className="px-6 py-2 bg-[#d8e0ff] text-[#242331] rounded-full hover:bg-[#c5d0ff] transition-colors">
                Design
              </button>
              <button className="px-6 py-2 bg-[#d8e0ff] text-[#242331] rounded-full hover:bg-[#c5d0ff] transition-colors">
                History
          ...
          <section className="mb-10">
            <div className="flex items-center mb-6">
              <h2 className="text-xl font-bold text-[#5570f1]">Podcasts</h2>
              <ChevronDown className="w-5 h-5 text-[#5570f1] ml-2" />
            </div>
          ...
          <section>
            <div className="flex items-center mb-6">
              <h2 className="text-xl font-bold text-[#5570f1]">Videos</h2>
              <ChevronDown className="w-5 h-5 text-[#5570f1] ml-2" />
            </div>
